#ifndef SERVICES_RENDERER_CPP
#define SERVICES_RENDERER_CPP

#include <services.hpp>


void Renderer::Initialize(Window const& window, std::int32_t index, std::uint32_t flags) {
    utility::SmartPointer<SDL_Renderer, SDL_CreateRenderer, SDL_DestroyRenderer>::Reset(window.Get(), index, flags);
}
